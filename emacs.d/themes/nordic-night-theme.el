...
;; Modified on: 2025
;; Modified by: MD
;; Reason: Colour and whitespace changes
...
;;; -- UI
     ...
     `(mode-line ((,class (:foreground ,nn-snowy5 :background ,nn-brightblack2 :width normal))))
     ...
     `(whitespace-hspace ((,class (:foreground ,nn-dark0 :background ,nn-dark3))))
     ...
     `(whitespace-space ((,class (:foreground ,nn-dark0 :background ,nn-nearblack))))
     ...
     `(whitespace-tab ((,class (:foreground ,nn-dark0 :background ,nn-nearblack))))
     ;; `(whitespace-trailing ((,class (:inherit trailing-whitespace))))
     `(whitespace-trailing ((,class (:foreground ,nn-red11 :background ,nn-red11))))
